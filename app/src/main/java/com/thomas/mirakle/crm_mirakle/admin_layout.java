...
public class admin_layout extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mail=findViewById(R.id.mail_admin);
        if(user!=null) {
            name.setText(user_);
            Mail.setText(e_mail);
        }
        ...
        photo=findViewById(R.id.photo_admin);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser() == null) {
                    Intent intent = new Intent(admin_layout.this, MainActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.admin_layout, menu);
        return true;
    }
